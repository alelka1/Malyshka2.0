package by.it.group251051.Malyshka.lesson05;
...
public class C_QSortOptimized {
    ...
    int[] getAccessory2(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < m; i++) {
            Segment lowPoint = new Segment(segments[0].start, points[i]);
            Segment highPoint = new Segment(points[i], segments[n - 1].stop);
