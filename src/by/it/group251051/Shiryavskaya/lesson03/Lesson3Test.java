...
public class Lesson3Test {
     ...
     * Поля:
     * Name: Test Shiryavskaya (тут ваша фамилия)
     * Test kind: All in package
     * Package: by.it.Shiryavskaya (тут ваша фамилия)
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group251051/Shiryavskaya/lesson03/dataHuffman.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group251051/Shiryavskaya/lesson03/encodeHuffman.txt");
