...
public class MyLinkedHashSet<E> implements Set<E>  {
    ...
    private MyLinkedNode[] array;
    private MyLinkedNode tail;
    private MyLinkedNode head;

    public MyLinkedHashSet(){
        array = new MyLinkedNode[SIZE_OF_ARRAY];
    }
    ...
    public boolean add(E e) {
        ...
        node.item = e;
        if(array[index] != null){
            MyLinkedNode startingNode = array[index];
    ...
    private void removeFromLinks(MyLinkedNode node){
    ...
    private void addToLinks(MyLinkedNode node){
        if(tail == null){
            tail = node;
            head = node;
        } else {
